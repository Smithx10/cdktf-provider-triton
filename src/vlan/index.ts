// https://www.terraform.io/docs/providers/triton/r/vlan
...
export function vlanTimeoutsToTerraform(struct?: VlanTimeoutsOutputReference | VlanTimeouts | cdktf.IResolvable): any {
...
export class Vlan extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "triton_vlan";
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/triton/r/vlan triton_vlan} Resource
  *
  ...
  */
  public constructor(scope: Construct, id: string, config: VlanConfig) {
    super(scope, id, {
      terraformResourceType: 'triton_vlan',
